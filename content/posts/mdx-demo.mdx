...
featuredImage: ../images/featured/writing.jpg
date: 2021-12-08
tags:
  - component
  - Mdx
...
[markdown web site]: http://daringfireball.net/projects/markdown/
...
You can use **_italics and bold together_** if you **_have to_**.
...
If you use this format for email addresses, Showdown will encode the address to make it harder for spammers to harvest. Try it and look in the _HTML Output_ pane to see the results:
